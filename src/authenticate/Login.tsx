...
export default function Login() {
  ...
  const validateEmail = (value: string) => {
    ...
    if (!emailRegex.test(value)) return setEmailError("Invalid email address"), false;
    setEmailError("");
    return true;
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#2b0057] to-[#2f1fff] px-4">
      <div className="bg-white p-8 rounded-xl shadow-xl w-full max-w-md">
        <h2 className="text-3xl font-bold text-center mb-6">Login to Optenix</h2>
        ...
        <p className="text-center mt-4">
          ...
          <Link to="/register" state={{ from }} className="text-blue-600 font-medium">
            Register
          </Link>
        </p>
      </div>
